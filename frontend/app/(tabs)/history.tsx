  ...
  return (
    <>
      <View className="flex-1 bg-gray-900 p-4">
        <Text
          className="mb-4 mt-8 text-center font-bold text-white"
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text className="mt-10 text-center text-gray-400" style={{ fontSize: RFValue(12) }}>
              {t('history.noPins')}
            </Text>
          }
          ...
          renderItem={({ item }) => (
            <Pressable
              ...
              <View className="flex-1" pointerEvents="none">
                <Text className="text-gray-400" style={{ fontSize: RFValue(10) }}>
