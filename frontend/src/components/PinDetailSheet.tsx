...
import { SharePinSheet } from './SharePinSheet';
    ...
    <BottomSheet
      ...
      <BottomSheetView className="p-6">
        {!pin ? null : (
          <>
            <View className="mb-4 flex items-start justify-between">
              <Text className="text-2xl font-bold text-white" style={{ fontSize: RFValue(15) }}>
                {t('pinDetail.title')}
              </Text>
            </View>
            ...
            <View className="mb-4">
              ...
              <Text className="font-medium text-white" style={{ fontSize: RFValue(12) }}>
                {pin.owner?.realName || t('pinDetail.unknown')}
              </Text>
            </View>
            <View className="mb-4">
              <View className="flex-row">
                <Text className="mr-4 text-gray-500" style={{ fontSize: RFValue(11) }}>
                  {t('pinDetail.note')}
                </Text>
                {!editing && isOwner && (
                  <Pressable
              ...
              {editing ? (
                <View className="mt-1 gap-2">
                  <TextInput
                    ...
                    style={{ minHeight: 70, fontSize: RFValue(12) }}
                  />
                ...
                <Text className="mt-1 text-white" style={{ fontSize: RFValue(12) }}>
                  {currentNote || t('pinDetail.noNotes')}
                </Text>
              )}
            </View>
            <View>
              ...
              <Text className="text-white" style={{ fontSize: RFValue(12) }}>
            ...
            <Pressable
              ...
              <Text className="text-center text-white" style={{ fontSize: RFValue(11) }}>
                Cerrar
              </Text>
            </Pressable>
          </>
        ...
        <SharePinSheet
          ...
          onClose={() => shareRef.current?.close()}
        />
      </BottomSheetView>
    </BottomSheet>
  );
